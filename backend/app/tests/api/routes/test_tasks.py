...
def test_create_task(
  ...
  data = {"title": "String", "description": "Another String", "priority_id": 0, "duration": 0, "id":task_id, "owner_id": owner_id}
...
def test_update_task(
   ...
   task = create_random_task(db)
   data = {"title": "Updated title", "description": "Updated description", "priority_id": 100, "duration": 100}
   response = client.put(
